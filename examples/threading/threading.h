...
struct thread_data{
     ...
     */
    pthread_mutex_t *mutex; // Added mutex pointer to the structure
    int wait_to_obtain_ms; // Added wait_to_obtain_ms to the structure
    int wait_to_release_ms; // Added wait_to_release_ms to the structure
